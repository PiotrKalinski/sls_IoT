...
const Users = ({ users }) => (
    <div id="sidebar-wrapper">
        <div id="sidebar">
            <ListGroup>
                <ListGroupItem key='title'><i>ATM</i></ListGroupItem>
                { users.map(User) }
            </ListGroup>
        </div>
    </div>
...
const Message = (message) => (
    <ListGroupItem key={message.id}><b>{message.username}</b>  status: {JSON.stringify(!message.status)} set: {JSON.stringify(message.set)}</ListGroupItem>
)
